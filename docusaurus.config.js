...
const config = {
  ...
  url: "https://interview-questions-lac.vercel.app",
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: "/Interview-Questions/",
        ...
        items: [
            ...
            items: [
              {
                ...
                to: "/docs/javascript/how-javascript-works",
              },
              {
                label: "Execution & Call Stack",
                to: "/docs/javascript/execution-and-call-stack",
              },
              { label: "Hoisting", to: "/docs/javascript/hoisting" },
              { label: "Closures", to: "/docs/javascript/closures" },
              {
                label: "Async & Event Loop",
                to: "/docs/javascript/async-javascript-event-loop",
              },
          ...
          },
          {
            ...
            items: [
              ...
              { label: "Hooks", to: "/docs/react/hooks" },
              {
                ...
                to: "/docs/react/component-lifecycle",
              },
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: "Reactivity Deep Dive",
                to: "/docs/vue/reactivity-system-deep-dive",
              },
              {
                label: "Pinia & Lifecycle Hooks",
                to: "/docs/vue/pinia-or-vuex-lifecycle-hooks",
              },
              {
                label: "Performance Tips",
                to: "/docs/vue/performance-tips-in-vue",
              },
            ],
          },
          {
            ...
            items: [
              {
                label: "How Node.js Works",
                to: "/docs/backend/how-nodejs-works",
              },
              {
                label: "HTTP Status Codes",
                to: "/docs/backend/http-status-codes",
              },
          ...
          },
          {
            ...
            items: [
              { label: "SQL vs NoSQL", to: "/docs/database/sql-vs-nosql" },
              {
                ...
                to: "/docs/database/database-transactions",
              },
              {
                label: "Horizontal vs Vertical Scaling",
                to: "/docs/cloud/horizontal-vs-vertical-scaling",
              },
